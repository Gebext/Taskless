...
function EditContent() {
  ...
  const { theme, allTasks, closeEditModal, selectedTasks } = useGlobalState();

  useEffect(() => {
    if (selectedTasks) {
      setTitle(selectedTasks.title || "");
      setDescription(selectedTasks.description || "");
      setDate(selectedTasks.date || "");
      setCompleted(selectedTasks.isCompleted || false);
      setImportant(selectedTasks.isImportant || false);
  ...
  return (
    <EditContentStyled onSubmit={handleSubmit} theme={theme}>
      ...
      <div className="input-control">
        ...
        <input
          value={date}
          defaultValue={selectedTasks.date}
